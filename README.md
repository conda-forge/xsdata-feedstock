...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xsdata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11259&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xsdata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xsdata` can be installed with:

```
conda install xsdata
```

It is possible to list all of the versions of `xsdata` available on your platform with:
